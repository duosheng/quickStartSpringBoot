import javacommon.base.SortInfo;
...
//			throw new IllegalArgumentException("Illegal argument type,must be : Map,Collection,Array,String. but was:"+o.getClass());
     ...
     */
    public static boolean checkOrderBy(String orderby,String validSortColumns) throws Exception{
        ...
        for(SortInfo info : infos) {
            ...
            if(!isPass(passColumns, info, columnName)) {
                throw new RuntimeException("mysql order by:["+orderby+"] is invalid, only can order by:"+validSortColumns);
            }
        }
        return true;
    }
