...
//import javacommon.util.LinkType;
...
public class JavaClass {
	...
	//将boclass放进来
	private JavaClass boClazz;

	private JavaClass poClazz;

	public JavaClass getBoClazz() {
		return boClazz;
	}

	public void setBoClazz(JavaClass boClazz) {
		this.boClazz = boClazz;
	}

	public JavaClass getPoClazz() {
		return poClazz;
	}

	public void setPoClazz(JavaClass poClazz) {
   ...
   public Set<JavaClass> getPropertiesImportClasses() throws Exception {
	...
	public String getSqlName() {
		String s = StringHelper.underscoreName(clazz.getSimpleName());
		if(s.endsWith("bo")){
...
//	public List<JavaField> getNotPkColumns(){
...
//				continue;
//			}
//			if(!doc.primaryKey() && doc.linkType() == LinkType.NONE){
//				list.add(new JavaField(field,this));
//			}
//		}
//
//		return list;
...
//	 * @return
//	 */
//	public List<JavaField> getPkColumns() {
//		List<JavaField> list = new ArrayList<>();
//		Field[] fields = clazz.getDeclaredFields();
//		for (Field field : fields) {
//			JsonDoc doc = field.getAnnotation(JsonDoc.class);
...
//	 * @return
//	 */
//	public List<JavaField> getAllColumns() {
//		List<JavaField> list = new ArrayList<>();
//		Field[] fields = clazz.getDeclaredFields();
//		for (Field field : fields) {
//			JsonDoc doc = field.getAnnotation(JsonDoc.class);
...
//	 * @return
//	 */
//	public List<JavaField> getOne2OneFields() {
//		List<JavaField> list = new ArrayList<>();
//		Field[] fields = clazz.getDeclaredFields();
//		for (Field field : fields) {
//			JsonDoc doc = field.getAnnotation(JsonDoc.class);
...
//				continue;
//			}
//			if(doc.linkType()== LinkType.One2One){
//				list.add(new JavaField(field,this));
//			}
//		}
//		return list;
...
//	 * @return
//	 */
//	public List<JavaField> getOne2ManyFields() {
//		List<JavaField> list = new ArrayList<>();
//		Field[] fields = clazz.getDeclaredFields();
//		for (Field field : fields) {
//			JsonDoc doc = field.getAnnotation(JsonDoc.class);
...
//				continue;
//			}
//			if(doc.linkType()== LinkType.One2Many){
//				list.add(new JavaField(field,this));
//			}
//		}
//		return list;
...
//	}
	 ...
	 * @return
	 */
//	public List<JavaField> getBoOne2OneFields() {
//		List<JavaField> list = new ArrayList<>();
//		Field[] fields = boClazz.getDeclaredFields();
//		for (Field field : fields) {
//			JsonDoc doc = field.getAnnotation(JsonDoc.class);
//			if(doc==null){
//				continue;
...
//	}
	...
	public String getEndSubClassName() {
		return StringHelper.endSubstring(getSimpleJavaType(),2);
	}
