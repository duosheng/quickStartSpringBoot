...
//	// ) && !(public void com.base..action.*.prepare())
//	@Pointcut("execution(public void com.base..action.*.*()) && !execution(public void com.base..action.*.prepare())")
//	public void aspect(){	}
//
//	/*
...
//				case "base":
//					baseUser baseUser = SessionUtil.getbaseUser(request);
...
//				case "pay":
//					baseUser payUser = SessionUtil.getbaseUser(request);
