...
////import com.base.auth.SessionUtil;
////import com.base.auth.baseUser;
//import javacommon.base.exception.BusinessException;
//import com.base.common.util.IpUtil;
...
////		request.setAttribute("loginUser", SessionUtil.getbaseUser(request));
...
////		baseUser loginUser = (baseUser) request.getAttribute("loginUser");
...
//	}
//
//	private void log(HttpServletRequest request, String param, int status, String result, long responseTime, baseUser loginUser, String jsessionid) {
//		try {
//			if (loginUser == null) {
//				MDC.put("userId", "-");
//			} else {
